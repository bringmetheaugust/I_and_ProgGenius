...
-   для зчитування можна було б погратись з Redis/node-lru-cache, але в завдані таких умов не було. Ідея б закючалась в
    тому щоб кешувати останю статистику, поки не приходять нові повідомлення.
